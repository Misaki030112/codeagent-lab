...
class TestBuildSummary(unittest.TestCase):
    ...
    def test_negatives(self):
        ...
        self.assertEqual(s["span"], 20)

    def test_keys_present(self):
        s = build_summary([1, 2, 3])
        for key in ("count", "sum", "min", "max", "average", "median", "span"):
            self.assertIn(key, s)
    ...
    def test_span(self):
        s = build_summary([3, 8, 1, 6])
        self.assertEqual(s["span"], 7)
